...
<div style="background-color:#f9f9f9;">
    <div style="background:#f9f9f9;background-color:#f9f9f9;Margin:0px auto;max-width:600px;">
        <table align="center" border="0" role="presentation"
            ...
            <tbody>
            <tr>
                <td style="border-bottom:#333957 solid 5px;direction:ltr;padding:20px 0;text-align:center;vertical-align:top;">
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <div style="background:#fff;background-color:#fff;Margin:0px auto;max-width:600px;">
        <table align="center" border="0" role="presentation" style="background:#fff;background-color:#fff;width:100%;">
            <tbody>
            <tr>
                <td style="border:#dddddd solid 1px;border-top:0px;direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                    <div class="mj-column-per-100 outlook-group-fix"
                        ...
                        <table border="0" role="presentation" style="vertical-align:bottom;" width="100%">
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <table align="center" border="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="width:64px;">
                                                <img height="auto" src="{{storage_path('app/public/KO1vcE9.png')}}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="64" />
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div
                                        ...
                                        Hello {{$name}}!<br></br>
                                        Thank you for signing up for Catalina McClure. We're really happy to have you!
                                    ...
                                    <table align="center" border="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="#2F67F6" role="presentation"
                                                ...
                                                valign="middle">
                                                <a href="{{route('login')}}" style="text-decoration: none"><p
                                            ...
                                            @if(isset($download))
                                                <td align="center" bgcolor="#2F67F6" role="presentation"
                                                    style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;"
                                                    valign="middle">
                                                    <a href="{{$download}}" style="text-decoration: none"><p
                                                            style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                            Download Welcome Mail
                                                        </p></a>
                                                </td>
                                            @endif
                                        </tr>
    ...
    <div style="Margin:0px auto;max-width:600px;">
        <table align="center" border="0" role="presentation" style="width:100%;">
            <tbody>
            <tr>
                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                    <div class="mj-column-per-100 outlook-group-fix"
                         style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                        <table border="0" role="presentation" width="100%">
                            <tbody>
                            <tr>
